...
export default function Login() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg,#1a2533,#1a3d4f)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, fontFamily: 'var(--font-gabarito), system-ui, sans-serif' }}>
